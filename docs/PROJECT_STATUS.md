...
## 序盤ストーリー導線更新（2026-09-22）

最新の序盤目的:
**はじまりのばしょ → はじまりのまち → はじまりのもり → ビーエのむら → レインランドのもり → レインランドじょうかまち／レインランドじょう → まじんのどうくつ**

主人公は序盤から「世界を救う使命」を与えられない。
最初は、自分がいる土地を知り、**レインランド王へ自分の旅の内容を報告し、増えているモンスターについて情報を集めるために王都へ向かう**。

各地域の移動理由:
- はじまりのばしょ → はじまりのまち: 人里を探し、自分がどこにいるか知る。
- はじまりのまち → はじまりのもり: レインランド王が各地のモンスター情報を集めていると知り、王都へ向かう最初の街道を進む。
- はじまりのもり → ビーエのむら: 森を抜けた先の中継地で休息・道確認・情報収集をする。
- ビーエのむら → レインランドのもり: ビーエで起きた事件とモンスター異常も王へ報告するため旅を続ける。
- レインランドのもり → レインランドじょうかまち: 王都へ到達する。
- 城下町 → レインランドじょう: 道中で見たモンスター増加・地域事件・異変を王へ報告し、各地の情報を集める。
- 王への報告 → まじんのどうくつ: 集まった情報から重要な異変地点として洞窟調査を依頼され、主人公が自分の意志で引き受ける。

この導線により、序盤の事件・戦闘はすべて「王への報告材料」となり、主人公個人の旅が徐々にレインランド全体の問題へ拡大する。

詳細正本: `PLAY_ORDER_SPEC.md` / `STORY_FLOW.md`
