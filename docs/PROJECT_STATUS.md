...
## ストーリー導線更新（2026-09-22）

物語上のプレイ順は `PLAY_ORDER_SPEC.md` を正とする。
...
序盤の目的:
- 主人公は自分がいる土地を知る。
- レインランド王へ旅の内容と道中で見たモンスター異変を報告するため王都を目指す。
- 王都で他地域のモンスター情報を集める。
- 王への報告後、まじんのどうくつ調査を自分の意志で引き受ける。

中盤以降:
- まじん撃破後、王へ再報告し、レインランドのむらの異変調査へ。
- レインランドのむらで得た狩人の情報からザボンへ。
- ザボンで岩山方面からモンスターが流れていると知り、いしのむら→いわやまのどうくつへ。
- 洞窟の記録からかくれざとへ進み、デーマスの塔と勇者装備の情報を得る。
- みずうみの古城→港町ダコハ→コタンカイムの洞窟→ポサロ城で勇者装備の手掛かりを追う。
- ふっかつのほこらで反射／ミラーの手掛かりを得て、デーマスの塔へ。
- デーマス撃破後、ぬまちのどうくつ→バトラスのとりで→オロチのしろへ進む。
- オロチまおう後は最終地点の裏ボス領域へ接続する。

設計ルール:
**各地域は、前地域で得た情報・事件・依頼のいずれかが次の移動理由になる。**
「次の町があるから行く」だけの進行にはしない。
