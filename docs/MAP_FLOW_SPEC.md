...
以下を2026-09-22時点の最新メイン進行一覧とする。
番号は物語順であり、旧コード上の互換No.とは別管理。

| 順 | マップ | 区分 | 特殊仕様 / 主な役割 |
|---:|---|---|---|
| 01 | はじまりのばしょ | 導入地点 | 焚き火から開始。主人公1人 |
| 02 | はじまりのまち | 町 | 最初の拠点 |
| 03 | ビーエのもり | 森 / 屋外探索 | 序盤戦闘・ビーエへの道 |
| 04 | ビーエのむら | 村 / 異常地域 | 小さなバグ景観 |
| 05 | レインランドのもり | 森 / 屋外探索 | 王都へ向かう探索 |
| 06 | レインランドじょうかまち / レインランドじょう | 城下町 / 城 | 王への報告。**城内部はブロック／ボクセル3Dを正式採用** |
| 07 | まじんのどうくつ | 特殊ダンジョン | 主人公1人。ターン制ダンジョンRPG。まじん戦 |
| 08 | ザボンのむら | 村 | タロサの出身地 |
| 09 | いわやまのどうくつ | 洞窟 / 特殊区間 | タロサ一時参加。縦シューティング要素 |
| 10 | かくれざと | 村 | ミレイと出会う |
| 11 | みずうみの古城 | 古城ダンジョン | ミレイの古代文字・知識が必要 |
| 12 | 港町ダコハ | 町 | デーマス関連情報 |
| 13 | コタンカイムの洞窟 | 洞窟 | ゆうしゃのたて |
| 14 | ポサロ城 | 城 / ボス地域 | バクラー戦。ゆうしゃのけん |
| 15 | ふっかつのほこら | ほこら | ゆうしゃのかんむり |
| 16 | デーマスのとう | 塔 / ボス地域 | デーマス戦。ミラー／ダイダイン |
| 17 | ぬまちのどうくつ | 特殊ダンジョン | 小型敵多数のリアルタイムアクション |
| 18 | いしのまち | 町 | 終盤準備拠点 |
| 19 | バトラスのとりで | 砦 / ボス地域 | 毒必須級。タロサの毒の矢 |
| 20-A | オロチへの道 | 終盤特殊区間 | **縦シューティング正式採用** |
| 20-B | オロチのしろ | ラストダンジョン | オロチまおう |
| 20-C | 最終地点 | 特殊地点 | オロチゾンビ／「もういちど」 |

追加マップ候補:
- **C01 ザボンの狩り場** — 候補 / 未採用。08周辺。
- C02 ダコハ海岸 — 削除済み。
- C03 バトラスのとりで周辺 — 削除済み。

特殊区間:
- 横アクション区間 — 正式採用 / 配置TBD。
- 縦アクション区間 — 正式採用 / 配置・仕様TBD。
- 06 レインランドじょうブロック／ボクセル3D — 配置確定。
- 20-A オロチへの道シューティング — 配置確定。
...
| 地域 | 区分 | 役割 / 備考 |
|---|---|---|
| ビーエのもり | 森 / 屋外探索 | 最新物語順03。旧「はじまりのもり」から名称変更 |
| レインランドのもり | 森 / 屋外探索 | 最新物語順05。ビーエのむらと王都の間 |
| いしのまち | 町 / 終盤準備 | 最新物語順18。旧「いしのむら」の名称・位置を更新 |

旧「レインランドのむら」は最新メインストーリー順から外す。存在自体を完全削除するか、任意地域／旧資産として残すかは別途整理する。
...
重要:
- 上記1〜20が最新の物語順。
- 旧「はじまりのもり」は「ビーエのもり」へ名称変更。
- 旧「レインランドのむら」は最新メイン進行から外す。
- 旧「いしのむら」は「いしのまち」へ名称・位置を更新し、18番で扱う。
- 互換No.は既存コード・アセット・旧資料を特定するためだけに残す。
- 各地域の物語上の役割は `PLAY_ORDER_SPEC.md` / `STORY_FLOW.md` を正とする。
...
最新1〜20を変更せず追加できる候補は `MAP_CANDIDATES.md` で管理する。

現時点の追加マップ候補:
- C01 ザボンの狩り場: 08「ザボンのむら」周辺。タロサ／狩り／中盤敵配置候補
...
正式採用へ移行:
- 06 レインランドじょう内部: ブロック／ボクセル化
- 20 オロチへの道: 縦シューティング
- 横アクション区間: 配置TBD
- 縦アクション区間: 配置・仕様TBD

C01にはまだ正式No.を与えない。最新物語順1〜20の番号自体は変更しない。
