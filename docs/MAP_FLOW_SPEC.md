...
現時点の主要候補:
- ザボンの狩り場: 08「ザボンのむら」周辺。タロサ／狩り／中盤敵配置候補
- ダコハ海岸: 12「港町ダコハ」周辺。海・水辺系敵配置候補
- バトラスのとりで周辺: 18→19間。終盤通常敵配置候補
- 横アクション区間: 正式採用だが配置TBD
- 縦アクション区間: 正式採用だが詳細TBD

これらにはまだ正式No.を与えない。採用しても最新物語順1〜20の番号自体を自動でずらさない。
